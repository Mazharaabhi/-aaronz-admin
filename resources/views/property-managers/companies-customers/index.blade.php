...
@section('title', 'Companies Customers')
@section('first', 'Companies Customers')
@section('second', 'Companies')
@section('third', 'Companies Customers')
@section('content')
...
<div class="content d-flex flex-column flex-column-fluid">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-4 my-2 my-md-0">
                                                <div class="input-icon">
                                                    {{-- <input type="text" class="form-control input-search" placeholder="By Name..." />
                                                    <span>
    ...
    <!--end::Entry-->
@include('admin.companies.companies-customers.js.index')
@endsection
