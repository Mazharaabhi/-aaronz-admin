...
@section('title', 'Manage Property Manager')
@section('first', 'Manage Property Manager')
@section('second', 'Property Manager')
@section('third', 'Manage Property Managers')
...
<div class="content d-flex flex-column flex-column-fluid">
                            ...
                            <div class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-6 d-flex justify-content-end">
                                            ...
                                            {{-- <div class="dropdown dropdown-inline mr-2">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                    ...
                                                    <ul class="navi flex-column navi-hover py-2">
                                                        <li class="navi-header font-weight-bolder text-uppercase font-size-sm text-danger pb-2">Choose an option:</li>
                                                        <li class="navi-item">
                                            ...
                                            <!--begin::Button-->
                                            @if ($add_permission == 1)
                                            <a href="{{ route('property-manager.create') }}" class="btn btn-danger font-weight-bolder mr-1" id="OpenAddModel">
    ...
    <!--end::Entry-->
@include('property-managers.manage-companies.js.index')
@endsection
