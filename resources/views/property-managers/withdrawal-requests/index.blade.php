...
@section('first', 'Withdrawal Requests')
@section('second', 'Companies')
@section('third', 'Withdrawal Requests')
...
<div class="content d-flex flex-column flex-column-fluid">
    ...
    <!--end::Entry-->
@include('admin.companies.withdrawal-requests.modals');
@include('admin.companies.withdrawal-requests.js.index');
@endsection
