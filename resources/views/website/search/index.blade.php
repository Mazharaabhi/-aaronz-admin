                                        ...
                                        <div class="home1-advnc-search home6">
                                            <ul class="h1ads_1st_list mb0">
                                                ...
                                                <li class="list-inline-item fourtBox">
                                                    <div class="search_option_two">
                                                        <div class="candidate_revew_select">
                                                            <select class="selectpicker w100 show-tick" id="property_types">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="details">
                                            <div class="tc_content">
                                                <div class="dtls_headr">
                                                    <a class="fp_price" href="{{ route('list-single-buy-properties', $prop->slug) }}">{{ number_format($prop->price) }} AED<small></small></a>
                                                </div>
                                                <h4>{{ $prop->title }}</h4>
                                            ...
                                            <div class="fp_footer">
                                                ...
                                                <a href="{{ route('list-single-buy-properties', $prop->slug) }}" class="rqst">View Details</a>
