						...
						<div class="col-lg-12">
							<div class="listing_single_description2 mt30-767 mb30-767">
								...
								<div class="single_property_social_share style2">
									<div class="price">
										<h2>AED {{ number_format($property->price) }}<small>/mo</small></h2>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="row">
									...
									<div class="col-md-6 col-lg-6 col-xl-4">
										...
										<ul class="list-inline-item">
											...
											<li><p><span>{{ $property->built_year }}</span></p></li>
										</ul>
									</div>
									<div class="col-md-6 col-lg-6 col-xl-4">
										<ul class="list-inline-item">
										...
										<ul class="list-inline-item">
											<li><p><span>{{ $property->bed_no }}</span></p></li>
											<li><p><span>{{ $property->bath_no }}</span></p></li>
											<li><p><span>0</span></p></li>
											<li><p><span>0 SqFt</span></p></li>
										</ul>
									</div>
									<div class="col-md-6 col-lg-6 col-xl-4">
										<ul class="list-inline-item">
