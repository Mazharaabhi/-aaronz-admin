         ...
         <section class="breadcrumbs-section">
			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
                    @php
                        $location_name = $location_state->name ? $location_state->name : 'your location';
                    @endphp
				...
				<div class="col-sm-12 col-md-12">
					<ul style="overflow:hidden;height:30px">
						@if ($areas->count())
                            ...
                            <li><a href="{{ route('property-by-city-area', ['city' => $location_state->slug, 'area' => $item->slug]) }}">{{ $item->name }}
