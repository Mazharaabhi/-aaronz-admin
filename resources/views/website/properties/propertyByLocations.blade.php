          ...
          <div class="typesList">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        @php
                            $location_name = $location->name ? $location->name : 'your location';
                        @endphp
                    ...
                    <div class="col-sm-12 col-md-12">
                        <ul style="overflow:hidden;height:30px">
                            @if ($buildings->count())
                                ...
                                <li><a href="{{ route('property-by-city-area-location-building', ['city' => $location_state->slug, 'area' => $location_area->slug, 'location' => $location->slug, 'building' => $item->slug]) }}">{{ $item->name }}
