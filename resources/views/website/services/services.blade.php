                        ...
                        @if ($list_services->count())
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="feat_property list">
                                   <a href="">
                                      <div class="thumb">
                                         <img class="" src="{{ asset('storage') }}/{{ $serv->image }}" alt="fp1.jpg">
                                      </div>
                                   </a>
                                   <div class="details">
                                      <a href="">
                                      ...
                                      <div class="tc_content">
                                         <a class="fp_service" href="#">{{ $serv->name }}  </a>
                                         <a href="">
                                         </a><a class="fp_price" href="#">Starting From AED <span>
                                         {{ $serv->list_services->count() ? $serv->list_services[0]->hourly_charges : 0 }} / Hour
                                         </span> </a>
                                         <a class="fp_tag" href="#">Signature</a>
                                         <h4></h4>
                                         <h4>Total Number Of Providers {{ $serv->list_services_count }}</h4>
                                      ...
                                      <div class="fp_footer">
                                         <div class="btn-group d-block">
                                            <div class="profile-detail">
                                               <div class="profile-img-ser"><img src="https://prop.techbay.co/storage/UserImages/sSvtmFwRcCR4IqizDHS5SYv5rVGeJVOuCb7cPVM9.png"></div>
                                               <div class="profile-title-ser">Cherwell Cleaner
                                                  <a class="call-btn-1 raise" href="#call">Call <i class="fa fa-phone"></i></a>
                                               </div>
                                            </div>
                                         </div>
                                         <img class="developer-logo" src="https://prop.techbay.co/storage/UserImages/sSvtmFwRcCR4IqizDHS5SYv5rVGeJVOuCb7cPVM9.png">
                                      </div>
                                   </div>
                                </div>
                             </div>
