...
<script>
    $(document).ready(function(){
         ...
         @include('locations.areas.js.geocoding')
         ...
         function getStates(location_country_id){
            $.ajax({
                url:"{{ route('location.areas.get-state') }}",
                method:"GET",
            ...
            //applying validations here
             if(!location_country_id){
                ...
                formData.append('_token',_token);
                 $.ajax({
                     url:"{{ route('location.areas.create-process') }}",
                     method:"POST",
                     data:formData,
                     contentType:false,
                     processData:false,
                    ...
                    // return console.log(res);
                       if(res == "true"){
                        ...
                        $('#title_english_error').html("This area name is already exist.");
                        $('#title_english').focus();
                       }else if(res == 'slug'){
