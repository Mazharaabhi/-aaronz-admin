...
<script>
    $(document).ready(function(){
         ...
         @include('locations.buildings.js.geocoding')
         ...
         getStates($('select[id="country"] :selected').val());
         function getStates(location_country_id){
            $.ajax({
                url:"{{ route('locations.buildings.get-state') }}",
                method:"GET",
         ...
         $('#area_id').change(function(){
            ...
            getLocations(location_area_id);
         });
         function getLocations(location_area_id){
            $.ajax({
                url:"{{ route('locations.buildings.get-location') }}",
                method:"GET",
        ...
        $('#add_language').click(function(){
            ...
            //applying validations here
             if(!location_country_id){
                ...
                $('#state_error').html("");
                $('#area_id_error').html("");
                return $('#location_id_error').html("Please select a area.");
                ...
                formData.append('_token',_token);
                 ...
                 $.ajax({
                     url:"{{ route('locations.buildings.create-process') }}",
                     method:"POST",
                     data:formData,
                     contentType:false,
                     processData:false,
                    ...
                    complete:function()
                    {
                     ...
                     success:function(res){
                       ...
                       if(res == "true"){
                        ...
                        $('#title_english_error').html("This building name is already exist.");
                        $('#title_english').focus();
                       }else if(res == 'slug'){
