...
try{
   if($(this).val() != ""){
    const address = $(this).val() + ', ' + $('select[id="location_id"] :selected').text() + ', ' + $('select[id="area_id"] :selected').text() +  ', ' + $('select[id="state"] :selected').text() + ', ' + $('select[id="country"] :selected').text();
    console.log(address);
