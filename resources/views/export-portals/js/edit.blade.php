...
<script>
    $(document).ready(function(){
         ...
         //for Update new PORTAL
        $('#edit_portal').click(function(){
            ...
            if(!title_english || !$.trim(title_english).length){
                ...
                formData.append('id',"{{ $portal->id }}");
                formData.append('_token',_token);

                 $.ajax({
                     url:"{{ route('manage-properties.export.portals.edit-process') }}",
                     method:"POST",
                     data:formData,
                     contentType:false,
                     processData:false,
                    ...
                    complete:function()
                    {
                     ...
                     success:function(res){
                       ...
                       if(res == "true"){
                        ToastSuccess("Portal Updated Successfully");
                       }else if(res == 'title'){
