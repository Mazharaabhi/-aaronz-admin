...
<div class="content d-flex flex-column flex-column-fluid">
        ...
        <div class="container-fluid">
            <div class="card card-custom gutter-b">
                {{-- <div class="card-body"> --}}
                    ...
                    <div class="card-body">
                        <fieldset>
                            <legend>Edit Export Portal:</legend>
                            <div class="row">
                            ...
                            <div class="group-contain" style="
                               ...
                               <div class="form-group" style="
                                  ...
                                  <div id="uploadList" class="list-group list-group-flush list-group-divider" style="margin: auto;">
                                     <img loading="lazy" src="{{ asset('storage') }}/{{ $portal->image }}" alt="Preview Image" id="blah-one" width="60%" class="">
                                  </div>
                               </div>
                            </div>
                            <!-- /.form-group -->
    ...
    <!--end::Entry-->
@include('export-portals.js.edit');
@endsection
