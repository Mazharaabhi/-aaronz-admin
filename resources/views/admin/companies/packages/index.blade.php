...
@section('first', 'Packages')
@section('second', 'Companies')
@section('third', 'Packages')
...
<div class="content d-flex flex-column flex-column-fluid">
                                ...
                                <table id="users-table" class="table">
                                    <thead>
                                        <tr>
                                            <th width="5%">Id</th>
                                            <th>Package Name</th>
                                            <th>Sales Amount limit</th>
                                            <th>Visa/Master Charges</th>
                                            <th>American Express Charges</th>
                                            <th>Fixed Cost</th>
    ...
    <!--end::Entry-->
@include('admin.companies.packages.modals');
@include('admin.companies.packages.js.index');
@endsection
