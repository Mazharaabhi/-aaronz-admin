...
@section('title', 'Companies Transactions')
@section('first', 'Companies Transactions')
@section('second', 'Companies')
@section('third', 'Companies Transactions')
...
<div class="content d-flex flex-column flex-column-fluid">
    ...
    <!--end::Entry-->
@include('admin.companies.companies-transactions.js.index')
@endsection
