...
<div class="content d-flex flex-column flex-column-fluid">
                            ...
                            <div class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-6 d-flex justify-content-end">
                                            ...
                                            <!--end::Dropdown-->
                                            <!--begin::Button-->
                                            <a href="{{ route('admin.companies.manage-companies.create') }}" class="btn btn-danger font-weight-bolder mr-1" id="OpenAddModel">
    ...
    <!--end::Entry-->
@include('admin.companies.manage-companies.js.index')
@endsection
