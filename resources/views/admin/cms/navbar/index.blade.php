...
<div class="content d-flex flex-column flex-column-fluid">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">@lang('translation.navbar_menu')</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a  class="text-muted">@lang('translation.cms_section')</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">@lang('translation.navbar_menu')</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <!--end::Entry-->
@include('admin.cms.navbar.modals');
@include('admin.cms.navbar.js.index')
@endsection
