...
@section('first', 'Manage Users')
@section('second', 'Administrator')
@section('third', 'Manage Users')
@section('content')
...
<div class="content d-flex flex-column flex-column-fluid">
                            ...
                            <div class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-6 d-flex justify-content-end">
                                            ...
                                            <!--begin::Button-->
                                            @if ($add_permission == 1)
                                            <a href="{{ route('admin.administrator.manage-users.create') }}" class="btn btn-danger font-weight-bolder mr-1" id="OpenAddModel">
    ...
    <!--end::Entry-->
@include('admin.administrator.manage-users.js.index')
@endsection
