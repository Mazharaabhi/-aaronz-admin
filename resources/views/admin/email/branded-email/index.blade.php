...
@section('title', 'Branded Email')
@section('first', 'Branded Email')
@section('second', 'Email')
@section('third', 'Branded Email')
...
<div class="content d-flex flex-column flex-column-fluid">
    ...
    <!--end::Entry-->
@include('admin.email.branded-email.modals');
@include('admin.email.branded-email.js.index');
@endsection
