    ...
    $(document).ready(function(){
        ...
        $('#save').click(function()
        {
            ...
            else if(description.length <= 20)
            {
                ...
                $('#short_title_english_error').html("");
                $('#image_error').html("");
                return $('#description_error').html("@lang('translation.description_length_error')");
            }
            else
            {
                $('#title_english_error').html("");
                ...
                formData.append('desc_english', description);
                formData.append('desc_arabic', description);
