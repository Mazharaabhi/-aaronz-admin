...
@section('title', 'Paytabs Json')
@section('first', 'Paytabs Json')
@section('second', 'Developer Section')
@section('third', 'Paytabs Json')
...
<div class="content d-flex flex-column flex-column-fluid">
    ...
    <!--end::Entry-->
@include('admin.developer-section.paytabs-json.modals');
@include('admin.developer-section.paytabs-json.js.index');
@endsection
