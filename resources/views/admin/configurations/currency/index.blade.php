...
<div class="content d-flex flex-column flex-column-fluid">
                            ...
                            <div class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-6 d-flex justify-content-end">
                                            <!--begin::Button-->
                                            @if ($add_permission == 1)
                                            <a href="#" class="btn btn-cherwell font-weight-bolder mr-1" id="OpenAddModel">
                                ...
                                <table id="users-table" class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Symbol</th>
                                            <th>From Currency</th>
                                            <th>To Currency (Default Currency)</th>
                                            <th>Rate</th>
                                            <th>Status</th>
    ...
    <!--end::Entry-->
@include('admin.configurations.currency.modals');
@include('admin.configurations.currency.js.index');
@endsection
