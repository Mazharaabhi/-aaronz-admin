...
@section('title', 'Paytsb Config')
@section('first', 'MyridePay Account')
@section('second', 'Configurations')
@section('third', 'MyridePay Account')
...
<div class="content d-flex flex-column flex-column-fluid">
    ...
    <!--end::Entry-->
@include('admin.configurations.paytabs-config.modals');
@include('admin.configurations.paytabs-config.js.index');
@endsection
