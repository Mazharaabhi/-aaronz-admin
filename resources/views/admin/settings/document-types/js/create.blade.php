         ...
         $('#add_language').click(function(){
           ...
           // return console.log(language_direction);
            ...
            if(!title_english || !$.trim(title_english).length){
                ...
                $('#title_english_error').html("The document type name field is required.");
                ...
                formData.append('_token',"{{ csrf_token() }}");
                 $.ajax({
                     url:"{{ route('admin.settings.document-types.create-process') }}",
                     method:"POST",
                     data:formData,
                     contentType:false,
                     processData:false,
                    ...
                    complete:function()
                    {
                     ...
                     success:function(res){
                       ...
                       if(res == "true"){
                        ...
                        ToastError("warning", "Document Type Already Exists.");
                        $('#title_english').focus();
                       }
                     },error:function(xhr){
