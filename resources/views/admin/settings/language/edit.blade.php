...
<div class="content d-flex flex-column flex-column-fluid">
                        ...
                        <div class="card-body">
                            <fieldset>
                                ...
                                <div class="col-md-12 col-lg-6 mb-4 ">
                                      ...
                                      <input type="text" name="title_english" id="title_english" value="{{ $language->name }}"  class="form-control" placeholder="Language Name">
                                  ...
                                  <div class="col-md-6 col-lg-6 mb-4 ">
                                    ...
                                    <select name="language_direction" id="language_direction" class="form-control">
                                        <option value="Left" @if($language->direction == "Left") {{ 'selected' }} @endif>Left</option>
                                        <option value="Right" @if($language->direction == "Right") {{ 'selected' }} @endif>Right</option>
                                    </select>
                                ...
                                <div class="group-contain" style="
                                   ...
                                   <div class="form-group" style="
                                      ...
                                      <div id="uploadList" class="list-group list-group-flush list-group-divider" style="margin: auto;">
                                         <img loading="lazy" src="{{ asset('storage') }}/{{ $language->flag_image }}" alt="Preview Image" id="blah-one" class="d-block">
                                      </div>
                                   </div>
                                </div>
                                <!-- /.form-group -->
    ...
    <!--end::Entry-->
@include('admin.settings.language.js.edit');
@endsection
