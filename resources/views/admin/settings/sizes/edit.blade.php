...
<div class="content d-flex flex-column flex-column-fluid">
                    ...
                    <div class="card-body">
                        <fieldset>
                            ...
                            <div class="col-md-12 col-lg-4 mb-4 ">
                                ...
                                <input type="text" name="size" placeholder="0" id="size" value="{{ $price->size }}" onkeypress="return isNumberKey(event)" class="form-control" autofocus>
                                <span id="size_error" class="text-danger"></span>
                            </div>
                            <div class="col-md-12 col-lg-4 mb-4 ">
                                  <label for="description_english" class="d-block">Decimal Size</label>
                                  <input type="text" name="decimal_size" placeholder="0.00" id="decimal_size" value="{{ $price->decimal_size }}" class="form-control" readonly>
                              </div>
                              <div class="col-md-12 col-lg-4 mb-4 ">
                                <label for="description_english" class="d-block">Compact Size</label>
                                <input type="text" name="compact_size" id="compact_size" class="form-control" value="{{ $price->compact_size }}" placeholder="0" readonly>
                            </div>
                            </div>
                        </fieldset>
    ...
    <!--end::Entry-->
@include('admin.settings.sizes.js.edit');
@endsection
