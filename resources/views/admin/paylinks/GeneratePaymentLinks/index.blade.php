                            ...
                            <div class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-6 d-flex justify-content-end">
                                            ...
                                            <!--end::Dropdown-->
                                            <!--begin::Button-->
                                            <a href="{{ route('admin.paylinks.generate-payment-link.create') }}" class="btn btn-danger font-weight-bolder mr-1" id="OpenAddModel">
...
@include('admin.paylinks.GeneratePaymentLinks.js.index')
@endsection
