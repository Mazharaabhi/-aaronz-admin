                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <img src="{{ asset('storage/'.$lead->requester->id_front) }}" alt="Emirate ID Fron" class="rounded" width="200px" width="50px">
                                </div>
                                <div class="col-6">
                                    <label for="" class="d-block"><b>Emirate ID Back:</b></label>
                                    <img src="{{ asset('storage/'.$lead->requester->id_back )}}" alt="Emirate ID Fron" class="rounded" width="200px" width="50px">
                                </div>
                            </div>
                  ...
                  <fieldset>
                      ...
                      <div class="row mb-2">
                        <div class="col-md-4 col-lg-4 mb-4">
                            ...
                            <input type="date" class="form-control" name="start_date" disabled id="start_date"/>
                        ...
                        <div class="col-md-4 col-lg-4 mb-4">
                            ...
                            <input type="date" class="form-control" name="check_date" disabled id="check_date"/>
                            <span class="form-text text-danger" id="check_date_error"></span>
                        </div>
                        <div class="col-md-6 col-lg-6 mb-4">
                            <label for="name">Yearly Rent:</label>
                            <input type="text" class="form-control" name="year_rent" disabled id="year_rent" value="{{ $property->year_rent }}" disabled autofocus/>
                            <span class="form-text text-danger" id="name_error"></span>
                        </div>
                        <div class="col-md-6 col-lg-6 mb-4">
                            <label for="name">No of Checks: </label>
                            <select name="check_no" id="check_no" disabled class="form-control">
                                <option value="">--select check nos.---</option>
                                <option value="12" {{ $lead->tenancy->check_no == 12 ? 'selected' : '' }}>12</option>
                                <option value="6" {{ $lead->tenancy->check_no == 6 ? 'selected' : '' }}>6</option>
                                <option value="4" {{ $lead->tenancy->check_no == 4 ? 'selected' : '' }}>4</option>
                                <option value="3" {{ $lead->tenancy->check_no == 3 ? 'selected' : '' }}>3</option>
                                <option value="2" {{ $lead->tenancy->check_no == 2 ? 'selected' : '' }}>2</option>
                                <option value="1" {{ $lead->tenancy->check_no == 1 ? 'selected' : '' }}>1</option>
                            </select>
                        ...
                        <div class="col-md-12 col-lg-12 mb-4" id="vouchers_div">
                            ...
                            <table class="table table-stripped table-bordered">
                                ...
                                <tbody>
                                @if (count($lead->tenancy->cheques) > 0)
                                    @foreach ($lead->tenancy->cheques as $key => $item)
                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            <td>{{ $item->amount }}</td>
                                            <td>{{ $item->due_date }}</td>
                                ...
                                <tfooer>
                                    <tr>
                                        <th colspan="2">Total Amount Due: AED {{ $lead->tenancy->total_amount }}</th>
                                        <th colspan="2">Total Amount Paid: AED 0</th>
                                    </tr>
                                </tfooer>
                            </table>
                        </div>
                  ...
                  <fieldset>
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                          ...
                          <tbody>
                              @if (count($lead->tenancy->tenant_images) > 0)
                              @foreach ($lead->tenancy->tenant_images as $key => $item){
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    <td>{{ $item->filename }}</td>
                                    <td>{{ $item->document_type_id }}</td>
                                    <td></td>
                                </tr>
                              }
                              @endforeach
                ...
                <fieldset>
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                          ...
                          <tbody>
                            @if (count($lead->tenancy->owner_images) > 0)
                            @foreach ($lead->tenancy->owner_images as $key => $item){
                              <tr>
                                  <td>{{ ++$key }}</td>
                                  <td>{{ $item->filename }}</td>
                                  <td>{{ $item->document_type_id }}</td>
...
@include('admin.contracts.property-contracts.js.edit')
@endsection
