...
$(document).ready(function(){
   ...
   MakeMenuActive('#manage_customer', '#all_customer', '#service_anchor');
    ...
    var widget_two_image_src = '';
    var filename = '';
    $("#header_image_1e").change(function() {
        var input = this;
        var filenamee = $(this).val().split('\\').pop()
        if (input.files && input.files[0]) {
        var reader = new FileReader();
        reader.onload = function(e) {
            widget_two_image_src = e.target.result;
            filename = filename;
        }
    ...
    $("#header_image_1").change(function() {
            ...
            $('#add-button-englishe').click(function(){
              ...
              // return console.log(imagee)
                ...
                // return console.log(propertye)
                    ...
                    let rowDatae=
                       `<td class="justify-content-center">${RowIDToUpdatee}</td>
                        <td class="justify-content-center">${widget_one_image_srce}
                            </td>
                        <td class="justify-content-center">
                            <a href="${widget_one_image_srce}" target="_blank">${widget_one_image_srce}</a>
                        </td>
                        <td class="text-center justify-content-center">
                            <input type="hidden" name="indexe" value="${indexe}"/>
                            <input type="hidden" name="ide" value="${RowIDToUpdatee}"/>
                            <input type="hidden" name="imagee" value="${widget_one_image_srce}"/>
                ...
                else
                {
                   ...
                   {
                        var propertye = document.getElementById('header_image_1').files[0];
                        document_filese.push(propertye);
                        document_type_idse.push(document_type_ide);
                        file_namese.push(imagee);
                        $('#image_1_errore').html("");
                    ...
                    buttons: {
                        ...
                        confirm: {
                            ...
                            action: function(){
                                ...
                                document_filese.splice(indexe, 1);
                                document_type_idse.splice(indexe, 1);
                                console.log(document_filese);
        ...
        const assigned_to = "{{ $lead->assigned_to? $lead->assigned_to->assigned_to : 1 }}";
