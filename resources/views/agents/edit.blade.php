                  ...
                  <fieldset>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-3">
                                  <span class="switch switch-outline switch-icon switch-success">
                                      <label>
                                          <input type="checkbox" {{($agent->is_company == 1) ? 'checked' : ''}} name="is_company_contact" id="is_company_contact">
                                          <span></span>
                                      </label>
                                  </span>
                              </div>
                      ...
                      <div class="col-md-6 col-lg-6 mb-4">
                        <div class="form-group row">
                            ...
                            <div class="col-3">
                                <span class="switch switch-outline switch-icon switch-success">
                                    <label>
                                        <input type="checkbox" {{($agent->is_management == 1) ? 'checked' : ''}} name="is_managment" id="is_managment">
                                        <span></span>
                                    </label>
                                </span>
                            </div>
                      ...
                      <div class="row mb-4">
                        <div class="col-md-6 col-lg-6 mb-4">
                            ...
                            <input type="text" class="form-control" value="{{ $agent->name }}" name="name" id="name" placeholder="@lang('translation.enter_name')" autofocus/>
                            <span class="form-text text-danger" id="name_error"></span>
                        </div>
                        <div class="col-md-6 col-lg-6 mb-4">
                            <label for="designation">@lang('translation.designation')</label>
                            <input type="text" class="form-control" value="{{ $agent->designation }}" name="designation" id="designation" placeholder="@lang('translation.enter_designation')"/>
                            <span class="form-text text-danger" id="designation_error"></span>
                        </div>
                        <div class="col-md-6 col-lg-6 mb-4">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" value="{{ $agent->email }}" name="new_email" id="new_email" placeholder="Enter Email"/>
                            <span class="form-text text-danger" id="new_email_error"></span>
                        </div>
                        <div class="col-md-6 col-lg-6 mb-4">
                            <label for="brn">BRN #</label>
                            <input type="text" class="form-control" value="{{ $agent->brn }}" name="brn" id="brn" placeholder="Enter BRN Number"/>
                            <span class="form-text text-danger" id="brn_error"></span>
                        </div>
                        <div class="col-md-6 col-lg-6 mb-4 ">
                            <label for="phone">Phone</label>
                            <input type="tel" class="form-control" value="{{ $agent->phone }}" name="phone" id="phone" placeholder="@lang('translation.enter_company_phone')" autofocus/>
                            ...
                            <select name="state_id" id="state_id" class="form-control">
                                ...
                                @if ($states->count())
                                    @foreach ($states as $item)
                                        <option value="{{ $item->id }}" {{ $agent->state == $item->id ? 'selected' : ''}}>{{ $item->name }}</option>
                                    @endforeach
                                @endif
                            </select>
                        ...
                        <div class="col-md-6 col-lg-6 mb-4 ">
                            ...
                            <input type="text" name="address" value="{{ $agent->address }}" id="address" placeholder="Enter Address" class="form-control">
                            ...
                            <select name="nationality" id="nationality" class="form-control" multiple>
                                ...
                                @if ($nationalities->count())
                                    @foreach ($nationalities as $item)
                                        <option value="{{ $item->id }}" @foreach ($nationality as $national) {{ $national == $item->id ? "selected" : ""  }} @endforeach>{{ $item->name }}</option>
                                    @endforeach
                                @endif
                            </select>
                            ...
                            <select name="specialities" id="specialities" class="form-control" multiple>
                                ...
                                @if ($types->count())
                                    @foreach ($types as $item)
                                        <option value="{{ $item->id }}" @foreach ($specialities as $speciality) {{ $speciality == $item->id ? "selected" : ""  }} @endforeach>{{ $item->name }}</option>
                                    @endforeach
                                @endif
                            </select>
                            ...
                            <select name="languages" id="langs" class="form-control" multiple>
                                ...
                                @if ($languages->count())
                                    @foreach ($languages as $item)
                                        <option value="{{ $item->id }}" @foreach ($langs as $lang) {{ $lang == $item->id ? "selected" : ""  }} @endforeach>{{ $item->name }}</option>
                                    @endforeach
                                @endif
                              </select>
                            </select>
                        ...
                        <div class="col-md-6 col-lg-6 mb-4">
                            <label for="password">RERA No. </label>
                            <input type="text" class="form-control" value="{{ $agent->rera_no }}" name="rera_no" id="rera_no" placeholder="RERA No."/>
                            <span class="form-text text-danger" id=""></span>
                        </div>
                        <div class="col-md-6 col-lg-6 mb-4">
                            <label for="key_location">Key Location. </label>
                            <input type="number" class="form-control" name="key_location" value="{{ $agent->key_location }}" id="key_location" placeholder="Key Location."/>
                            <span class="form-text text-danger" id=""></span>
                        </div>
                                ...
                                <div class="group-contain" style="
                                   ...
                                   <div class="form-group" style="
                                      ...
                                      <div id="uploadList" class="list-group list-group-flush list-group-divider" style="margin: auto;">
                                         <img loading="lazy" src="{{ $agent->avatar }}" alt="Preview Image" id="blah-one" class="">
                                      </div>
                                   </div>
                                </div>
                        ...
                        <div class="col-md-12 col-lg-12 mb-6">
                            <label class="mr-2">Descriptions</label>
                              <textarea class="form-control"  name="descriptions" id="descriptions">{{ $agent->about }}</textarea>
                  ...
                  <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="meta_title" value="{{ $agent->meta_title }}" id="meta_title" class="form-control" />
                        </div>
                        <div class="col-md-6">
                            <label for="meta_description">Meta Descriptions</label>
                            <input type="text" name="meta_description" value="{{ $agent->meta_description }}" id="meta_description" class="form-control" />
                        </div>
                    </div>
                </fieldset>
                  <div class="row mb-6">
                    <div class="col-md-12 col-lg-12 mb-6">
                        <button class="btn btn-cherwell btn-block" style="font-size:16px;" id="save"><span class="svg-icon svg-icon-md fa fa-floppy-o"></span> @lang('translation.update')</button>
                    </div>
                  </div>
                 </div>
                <!--end::Form-->
