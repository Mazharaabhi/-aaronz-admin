...
<div class="content d-flex flex-column flex-column-fluid">
                ...
                <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="col-lg-6 col-xl-6 d-flex justify-content-end">
                                        <!--begin::Button-->
                                        <a href="{{ route('manage-properties.property.create') }}" class="btn btn-cherwell font-weight-bolder mr-1" id="OpenAddModel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-6 d-flex justify-content-end">
                                            <!--begin::Button-->
                                            <a href="{{ route('manage-properties.property.index')}}" role="button"   class="btn btn-outline-primary mx-2">Cancel</a>
                                            <!--end::Button-->
                                            <!--begin::Button-->
    ...
    <!--end::Entry-->
@include('properties.list-properties.js.index');
@endsection
