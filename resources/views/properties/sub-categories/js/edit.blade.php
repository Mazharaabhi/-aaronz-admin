...
<script>
    $(document).ready(function(){
         ...
         $.ajax({
                    ...
                    method:"GET",
                    data:{property_type_id:"{{ $storedData[0]->categories->types->id }}"},
                    success:function(res){
                        $('#service_id').html(res);
                        $('#service_id').val("{{ $storedData[0]->property_category_id }}");
                    },error:function(xhr)
                    {
            ...
            //applying validations here
             ...
             else if(!property_category_id)
             {
                ...
                formData.append('_token',_token);
                 ...
                 $.ajax({
                     url:"{{ route('manage-properties.property-settings.sub-categories.edit-process') }}",
                     method:"POST",
                     data:formData,
                     contentType:false,
                     processData:false,
