...
@section('first', 'Developers')
@section('second', 'Manage Properties')
@section('third', 'Developers')
@section('fourth', 'Edit')
...
<div class="content d-flex flex-column flex-column-fluid">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                           <div class="example-tools justify-content-center">
                               <a href="{{ route('manage-properties.developers.index') }}" class="btn btn-cherwell float-right"><span class="fa fa-mail-reply"></span> Back</a>
                           </div>
                          </div>
                       </div>
                    <div class="card-body">
                        <fieldset>
                            <legend>Edit Developer:</legend>
                            <div class="row">
                                <!-- grid column -->
                        ...
                        <button type="button" class="btn btn-cherwell font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3 btn-block" id="add_developer">
    ...
    <!--end::Entry-->
@include('properties.developers.js.edit');
@endsection
