...
<script>
    $(document).ready(function(){
         ...
         MakeMenuActive('#c_properties', '#gallary', '#cms_anchor');
        ...
        $('#add_language').click(function(){
            ...
            //applying validations here
             if(!title_english || !$.trim(title_english).length){
                 $('#title_english_error').html("The view title field is required.");
                 hideInputs();
                ...
                $('.btn_lang').attr('class', 'btn btn_lang mt-3 btn-cherwell lang-buttons');
                $(`#div_${input_id}`).attr('class', 'col-md-12 mb-3');
                return $('#title_english_error').html("The view title field must be at least 3 character.");
            }else{
                ...
                formData.append('_token',_token);
                 ...
                 $.ajax({
                     url:"{{ route('manage-properties.property-settings.gallaries.create-process') }}",
                     method:"POST",
                     data:formData,
                     contentType:false,
                     processData:false,
                    ...
                    complete:function()
                    {
                     ...
                     success:function(res){
                       ...
                       if(res == "true"){
                        ...
                        ToastSuccess("Gallary Created Successfully");
                       }else if(res == 'title'){
                        $('#title_english_error').html("This gallary title is already exist.");
                        $('#title_english').focus();
                       }
