...
<script>
    $(document).ready(function(){
         ...
         MakeMenuActive('#c_properties', '#views', '#cms_anchor');
            ...
            //applying validations here
             if(!title_english || !$.trim(title_english).length){
                ...
                formData.append('_token',_token);
                 ...
                 $.ajax({
                     url:"{{ route('manage-properties.property-settings.views.create-process') }}",
                     method:"POST",
                     data:formData,
                     contentType:false,
                     processData:false,
                    ...
                    complete:function()
                    {
                     ...
                     success:function(res){
                       ...
                       if(res == "true"){
                        ...
                        ToastSuccess("View Created Successfully");
                       }else if(res == 'title'){
                        $('#title_english_error').html("This view title is already exist.");
                        $('#title_english').focus();
                       }
