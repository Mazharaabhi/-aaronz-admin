...
<div class="content d-flex flex-column flex-column-fluid">
                            ...
                            <div class="mb-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-6 d-flex justify-content-end">
                                            <!--begin::Button-->
                                            <a href="{{ route('manage-properties.property-settings.features.create') }}" class="btn btn-cherwell font-weight-bolder mr-1" id="OpenAddModel">
    ...
    <!--end::Entry-->
@include('properties.features.js.index');
@endsection
