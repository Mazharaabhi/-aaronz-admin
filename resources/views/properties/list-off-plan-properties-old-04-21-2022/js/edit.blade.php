          ...
          //  alert('hello')
            ...
            if(property_category_id == ""){
                ...
                formData.append('_token',_token);
                 $.ajax({
                     url:"{{ route('offplan.property.edit-process') }}",
                     method:"POST",
                     data:formData,
                     contentType:false,
                     processData:false,
                     ...
                     beforeSend:function()
                    {
                        $('#update_property').html(`${save_icon} @lang('translation.please_wait')`);
                        $('#update_property').attr('class',`${btn_cherwell } btn-block  ${spinner}`);
                        $('#update_property').attr('disabled',true);
                    },
                    complete:function()
                    {
                        $('#update_property').html(`${save_icon} List New Property`);
                        $('#update_property').attr('class',`${btn_cherwell } btn-block`);
                        $('#update_property').removeAttr('disabled');
                    },
                     success:function(res){
                         console.log(res);
                       if(res == "true"){
                        ToastSuccess("Off Plan Property Updated Successfully");
                         $('input[name="title_english[]"]').map(function(){
                            $(this).val('');
                        });
