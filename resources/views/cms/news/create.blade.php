                             ...
                             {{-- @foreach ($languages as $item)
                              <div class="col-md-12 mb-3 {{ $item->id != 1 ? 'd-none' : '' }}" id="div_description_{{ $item->id }}">
                                <div class="form-group">
                                  ...
                                  <textarea name="description_english[]" id="description_english_{{ $item->id }}" class="form-control @if($item->direction =='Right' ) direction @endif" cols="30" rows="10"></textarea>
