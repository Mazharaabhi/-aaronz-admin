...
<script>
    $(document).ready(function(){
        ...
        $('#add_language').click(function(){
            const news_category_id = $('#news_category_id').val();
          ...
          //***MAKING ARRAY OF DESC START HERE****//
            ...
            if(news_category_id == ""){
                ...
                for(var count = 0; count<descriptions.length; count++){
                 ...
                 $.ajax({
                     url:"{{ route('cms.news.create-process') }}",
                     method:"POST",
                     data:formData,
                     contentType:false,
                     processData:false,
                    ...
                    complete:function()
                    {
                     ...
                     success:function(res){
                       ...
                       if(res == "true"){
                        ...
                        $('textarea[name="description_english_1"]').map(function(){
                            $(this).val('');
                        });
                        $(`#title_english_${input_id}`).focus();
                        ToastSuccess("News Created Successfully");
                       }
