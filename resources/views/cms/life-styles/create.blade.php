...
<div class="content d-flex flex-column flex-column-fluid">
            ...
            <div class="card card-custom gutter-b">
                {{-- <div class="card-body"> --}}
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 mb-6 ">
                                    <label class="mr-2">Youtube Link</label>
                                      <input type="text" placeholder="https://www.youtube.com/embed/MigrDLUErX4" class="form-control" id="button_link">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12 mb-6 ">
                                <label class="mr-2">Descriptions</label>
                                  <textarea class="form-control" id="lifestyle_desc"></textarea>
                        ...
                        <button type="button" class="btn btn-cherwell font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3 btn-block" id="add_lifestyle">
    ...
    <!--end::Entry-->
@include('cms.life-styles.js.create');
@endsection
