...
<div class="content d-flex flex-column flex-column-fluid">
        ...
        <div class="container-fluid">
            <div class="card card-custom gutter-b">
                {{-- <div class="card-body"> --}}
                    ...
                    <div class="card-body">
                        <fieldset>
                            <legend>Edit Video URL:</legend>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                  <label for="video_url">Video URL</label>
                                  <input type="text" name="video_url" value="{{ $aaronz_life->video_url }}" id="video_url" placeholder="" class="form-control">
                                  <small id="video_url_error" class="text-danger"></small>
                                </div>
                           </div>
                        </fieldset>
                        <button type="button" class="btn btn-cherwell font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3 btn-block" id="edit_video_url">
    ...
    <!--end::Entry-->
@include('cms.life-at-aaronz.js.edit');
@endsection
