...
<div class="content d-flex flex-column flex-column-fluid">
        ...
        <div class="container-fluid">
            <div class="card card-custom gutter-b">
                {{-- <div class="card-body"> --}}
                    ...
                    <div class="card-body">
                        <fieldset>
                            <legend>Add Instagram Feed:</legend>
                            <div class="row">
                                <div class="col-md-6 col-lg-6 mb-6 ">
                                    <label class="mr-2">Title</label>
                                     <input type="text" class="form-control" id="insta_feed_title">
                                    <small id="insta_feed_title_error" class="text-danger"></small>
                                </div>
                                <div class="col-md-6 col-lg-6 mb-6 ">
                        ...
                        <button type="button" class="btn btn-cherwell font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3 btn-block" id="add_news_feed">
    ...
    <!--end::Entry-->
@include('cms.instagram-feeds.js.create');
@endsection
