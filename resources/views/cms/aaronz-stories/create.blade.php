...
@section('title', 'Aaronz Stories Sell With Us')
@section('first', 'Aaronz Stories')
@section('second', 'CMS')
@section('third', 'Aaronz Stories')
...
<div class="content d-flex flex-column flex-column-fluid">
        ...
        <div class="container-fluid">
            <div class="card card-custom gutter-b">
                {{-- <div class="card-body"> --}}
                    ...
                    <div class="card-body">
                        <fieldset>
                            <legend>Add Aaronz Stories:</legend>
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4 mb-4 ">
                                    <label class="mr-2">Heading</label>
                                      <input type="text" class="form-control" id="story_heading">
                        ...
                        <button type="button" class="btn btn-cherwell font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3 btn-block" id="add_aronz_story">
    ...
    <!--end::Entry-->
@include('cms.aaronz-stories.js.create');
@endsection
