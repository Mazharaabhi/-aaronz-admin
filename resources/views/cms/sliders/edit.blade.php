                    ...
                    <div class="card-header">
                        <div class="card-toolbar">
                           <div class="example-tools justify-content-center">
                               <a href="{{ route('cms.sliders.index') }}" class="btn btn-cherwell float-right"><span class="fa fa-mail-reply"></span> Back</a>
                           </div>
                          </div>
                       </div>
                    <div class="card-body">
                        <fieldset>
                            <legend>Edit Slider:</legend>
                              <div class="row">
                                    <div class="col-md-4 col-lg-4 mb-4 ">
                                        ...
                                        <input type="text" class="form-control" value="{{ $slider->title }}" id="slider_title">
                                        <small id="slider_title_error" class="text-danger"></small>
                                    </div>
                                    <div class="col-md-4 col-lg-4 mb-4 ">
                                        <label class="mr-2">Heading</label>
                                        <input type="text" class="form-control" value="{{ $slider->heading }}" id="slider_heading">
                                        <small id="slider_heading_error" class="text-danger"></small>
                                    </div>
                                    <div class="col-md-4 col-lg-4 mb-4 ">
                                        <label class="mr-2">Link</label>
                                          <input type="text" class="form-control" value="{{ $slider->button_link }}" id="button_link">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12 mb-6 ">
                                    ...
                                    <textarea class="form-control" id="slider_desc">{{ $slider->description }}</textarea>
                                    <small id="slider_desc_error" class="text-danger"></small>
                                </div>
                            </div>
                            <div class="row">
                               <div class="col-md-12 col-lg-12 mb-4 ">
                                <label class="mr-2">Upload Slider Image :  3000px * 2000px (3.2 Aspect Ratio)</label>
                                <div class="group-contain" style="
                                   ...
                                   <div class="form-group" style="display: block; margin: 0 auto;">
                                      <div id="uploadList" class="list-group list-group-flush list-group-divider" style="margin: auto;">
                                         <img loading="lazy" src="{{ $slider->image }}" alt="Preview Image" id="blah-one" class="">
                                      </div>
                                   </div>
                                </div>
                                <!-- /.form-group -->
