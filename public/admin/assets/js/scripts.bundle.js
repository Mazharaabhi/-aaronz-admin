...
var KTLayoutChat = function () {
	...
	var _handeMessaging = function(element) {
		...
		html += '		<img loading="lazy" alt="Pic" src="assets/media/users/300_12.jpg"/>';
		html += '	</div>';
		html += '</div>';
...
$('#admin_application_mode').on('change', function (e) {
    var optionSelected = $("option:selected", this);
    var valueSelected = this.value;
 if(valueSelected=='2'){
     $("#admin_application_mode").css("background-color","#F64E60");
 }
 else{
    $("#admin_application_mode").css('background-color','#F1BC5BD');
}
});
$(function() {
    $( ".menu-close-btn" ).click(function() {
        $( "#kt_profile_aside" ).hide();
      });
      $( "#profile-menu" ).click(function() {
        $( "#kt_profile_aside" ).show();
      });
