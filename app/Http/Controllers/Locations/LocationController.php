...
class LocationController extends Controller
{
    ...
    {
        $areas = Location::with('location_countries', 'location_states', 'location_areas')->orderBy('id', 'DESC')->where(['lang_id' => 1,'location_state_id' => 1])->get();
        ...
        if($request->ajax())
        {
            ...
            ->addColumn('action', function ($areas){
                    return '
                     <a href="'.route('locations.locations.edit', ['id' => $areas->id]).'" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-1" data-toggle="tooltip" data-theme="dark" title="Edit">
        ...
        return view('locations.locations.index');
    }
    ...
    public function create(){
        ...
        return view('locations.locations.create',compact('languages', 'location_countries'));
    }
    ...
    public function create_process(Request $request){
      // return $request->all();
         ...
         $CheckLocationName = Location::where([
         ...
         //checking for unique rank name
         $CheckLocationSlug = Location::where([
            'slug' => $request->slug,
            'lang_id' => 1,
            'location_country_id' => $request->location_country_id,
            'location_state_id' => $request->location_state_id,
    ...
    public function edit($id){
        ...
        return view('locations.locations.edit', compact('rank','languages','storedData', 'location_countries'));
    }
