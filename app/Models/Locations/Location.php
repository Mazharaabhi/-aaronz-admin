...
class Location extends Model
{
    ...
    {
        return $this->belongsTo('\App\Models\Locations\LocationArea', 'location_area_id')->where('lang_id', 1);
    }
    ...
    {
        return $this->hasMany('\App\Models\Locations\LocationBuilding', 'location_id');
    }
